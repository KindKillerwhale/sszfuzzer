...
//go:generate go run ../cmd/sszgen_clear -type SingleFieldTestStructMonolith -out gen_single_field_test_struct_monolith_ssz_clear.go
//go:generate go run ../cmd/sszgen_clear -type SmallTestStructMonolith -out gen_small_test_struct_monolith_ssz_clear.go
//go:generate go run ../cmd/sszgen_clear -type FixedTestStructMonolith -out gen_fixed_test_struct_monolith_ssz_clear.go
//go:generate go run ../cmd/sszgen_clear -type BitsStructMonolith -out gen_bits_struct_monolith_ssz_clear.go

//go:generate go run ../cmd/sszgen_clear -type ExecutionPayloadMonolith -out gen_execution_payload_monolith_ssz_clear.go
//go:generate go run ../cmd/sszgen_clear -type ExecutionPayloadMonolith2 -out gen_execution_payload_monolith_2_ssz_clear.go
//go:generate go run ../cmd/sszgen_clear -type ExecutionPayloadHeaderMonolith -out gen_execution_payload_header_monolith_ssz_clear.go
//go:generate go run ../cmd/sszgen_clear -type BeaconBlockBodyMonolith -out gen_beacon_block_body_monolith_ssz_clear.go
//go:generate go run ../cmd/sszgen_clear -type BeaconStateMonolith -out gen_beacon_state_monolith_ssz_clear.go
//go:generate go run ../cmd/sszgen_clear -type ValidatorMonolith -out gen_validator_monolith_ssz_clear.go
