...
//go:generate go run ../cmd/sszgen_clear -type SingleFieldTestStructMonolith -out clearSSZ/gen_single_field_test_struct_monolith_ssz.go
//go:generate go run ../cmd/sszgen_clear -type SmallTestStructMonolith -out clearSSZ/gen_small_test_struct_monolith_ssz.go
//go:generate go run ../cmd/sszgen_clear -type FixedTestStructMonolith -out clearSSZ/gen_fixed_test_struct_monolith_ssz.go
//go:generate go run ../cmd/sszgen_clear -type BitsStructMonolith -out clearSSZ/gen_bits_struct_monolith_ssz.go

//go:generate go run ../cmd/sszgen_clear -type ExecutionPayloadMonolith -out clearSSZ/gen_execution_payload_monolith_ssz.go
//go:generate go run ../cmd/sszgen_clear -type ExecutionPayloadMonolith2 -out clearSSZ/gen_execution_payload_monolith_2_ssz.go
//go:generate go run ../cmd/sszgen_clear -type ExecutionPayloadHeaderMonolith -out clearSSZ/gen_execution_payload_header_monolith_ssz.go
//go:generate go run ../cmd/sszgen_clear -type BeaconBlockBodyMonolith -out clearSSZ/gen_beacon_block_body_monolith_ssz.go
//go:generate go run ../cmd/sszgen_clear -type BeaconStateMonolith -out clearSSZ/gen_beacon_state_monolith_ssz.go
//go:generate go run ../cmd/sszgen_clear -type ValidatorMonolith -out clearSSZ/gen_validator_monolith_ssz.go
